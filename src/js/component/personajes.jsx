...
const Personajes = () => {
    ...
    function traerPersonajes() {
        fetch("https://swapi.dev/api/people")
            ...
            .then((data) => setApiInfo(data.results))
    };
                    ...
                    {apiInfo.map((i) => (
                        <div className="cardPersonajes card-container" >
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text textoPersonajes">Género: {i.gender}</p>
                                <p className="card-text">Color de pelo: {i.hair_color}</p>
                                <p className="card-text">Color de ojos: {i.eye_color}</p>
                                <a href="#" className="btn btn-primary botonInfo">Más info</a>
                            </div>
                        </div>))}
